...
from utils import CustomException  # Assuming you have a utils module
...
if __name__ == "__main__":
    ...
    train_df.to_csv(r"D:\campusx_dsmp2\9. MLOps revisited\cars24_mlops_project\artifacts\transformed_data\train\train.csv")
    test_df.to_csv(r"D:\campusx_dsmp2\9. MLOps revisited\cars24_mlops_project\artifacts\transformed_data\test\test.csv")
    ...
    # save_transformed_data(X_train_selected, y_train, X_test_selected, y_test,
    #                       train_data_dir="artifacts/transformed_data/train",
    #                       test_data_dir="artifacts/transformed_data/test")
